...
const taskDetails = {
  '1': {
    ...
    fullDescription:
      'A hidratação facial matinal é essencial para manter sua pele saudável e protegida durante todo o dia. Use um hidratante com FPS 30 ou superior, aplicando em movimentos circulares suaves, começando pelo centro do rosto e espalhando em direção às laterais.',
    tips: [
  ...
  '2': {
    ...
    fullDescription:
      'Série de exercícios focados em fortalecer os músculos do core e corrigir a postura. Estes exercícios ajudam a reduzir dores nas costas e melhorar sua presença física.',
    tips: [
  ...
  '3': {
    ...
    fullDescription:
      'Momento de escolher o look do dia baseado nas sugestões personalizadas do seu perfil. Considere o clima, ocasião e seu objetivo de estilo pessoal.',
    tips: [

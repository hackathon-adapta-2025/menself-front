...
export const Profile = () => {
  ...
  const menuItems = [
    { icon: User, label: 'Editar Perfil', action: () => console.log('Editar perfil') },
    ...
    { icon: HelpCircle, label: 'Ajuda e Suporte', action: () => console.log('Ajuda') },
    { icon: LogOut, label: 'Sair', action: () => console.log('Logout'), danger: true },
  ];
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="px-4 py-6">
        ...
        <div className="glass-card rounded-xl p-6 text-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-foreground mb-1">{userName}</h2>
